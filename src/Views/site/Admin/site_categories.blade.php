...
@section('title')
Admin area: {{ trans('site::site_admin.page_category') }}
@stop
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-heading">
                <h3 class="panel-title bariol-thin"><i class="fa fa-group"></i> {!! trans('site::site_admin.site_name_label').$site_name !!}</h3>
            </div>
